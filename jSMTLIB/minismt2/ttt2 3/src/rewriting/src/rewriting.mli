...
module type SUBSTITUTION = sig
 ...
 (** [is_renaming s] checks whether [s] is a variable renaming. This function is
 a synonym for [is_bijective]. *)
...
module type REWRITE = sig
 ...
 val step_add_label : ?left:bool -> step -> int -> step
...
module type DIAGRAM = sig
 ...
 val label : (int -> step -> (int * step)) -> int -> t -> t
 ...
 val is_par_decreasing : ('a -> step -> ('a * step)) -> 'a -> t -> bool
