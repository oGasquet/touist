...
module Result = Processorsx.Result;;
...
module Termination = struct
 ...
 module Ordinal = Processorsx.OrdinalInterpretation;;
...
module Transformation = struct
 ...
 module Sorted = Processorsx.Sorted;;
 ...
 module Cr = Processorsx.Cr;;
 module Commute = Processorsx.Commute;;
end
...
module Confluence = struct
 ...
 module Decreasing= Processorsx.Decreasing;;
 module Closed = Processorsx.Closed;;
 module GroundCR = Processorsx.GroundCR;;
 module AotoToyama = Processorsx.AotoToyama;;
 module KleinHirokawa = Processorsx.KleinHirokawa;;
end

module XmlOutput = Processorsx.XmlOutput;;
