...
(*** FUNCTIONS ****************************************************************)
let (>>=) = M.(>>=);;
let apply solve = M.get >>= (M.lift <.> solve <.> S.get_problem);;

(* predicates *)
let applicative = apply <.> Applicative.solve;;
...
let overlapping = apply <.> Overlapping.solve;;
let overlay = apply <.> Overlay.solve;;
...
let strongly_nonoverlapping = apply <.> StronglyNonOverlapping.solve;;
let trs = apply <.> Trs.solve;;
let wcr = apply <.> Wcr.solve;;
