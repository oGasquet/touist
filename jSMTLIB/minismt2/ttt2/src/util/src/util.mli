...
module List : sig
 ...
 val compare_length : 'a list -> 'a list -> int
 (** [compare_length a b] compares the list lengths of two lists. If the list
 length of [a] is smaller than that of [b], then [-1] will be returned. If the
 list lengths are equal, [0] will be returned. Otherwise, [1] will be returned.
 *)
...
@since  Wed Nov 27 13:49:23 CET 2013 *)

(** Result type for comparison by partial orders *)
module Order : sig
 (*** TYPES *******************************************************************)
 type t = GT | EQ | NONE;;
 ...
 val is_gt : t -> bool
 (** [is_gt x] returns true if [x = GT] *)
 val is_eq : t -> bool
 (** [is_eq x] returns true if [x = EQ] *)
 val is_ge : t -> bool
 (** [is_ge x] returns true if [x = GT] or [x = EQ] *)
 val lex : t list -> t
 (** [lex xs] combines [xs] lexicographically *)

 (** {3 Printers} *)

 val fprintf : Format.formatter -> t -> unit
 (** [fprintf fmt x] writes pretty printed output of [x]. *)
end
