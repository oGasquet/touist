...
let add_rlab f = employ "not found" <.> S.add_rlab f;;
let incr_curry = employ "not found" <.> S.incr_curry;;
let modify_curry f = employ "not found" <.> S.modify_curry f;;
let modify_height f = employ "not found" <.> S.modify_height f;;
let modify_rlab f = employ "not found" <.> S.modify_rlab f;;
let modify_slab f = employ "not found" <.> S.modify_slab f;;
...
(* Printers *)
let fprintfx_fun f fmt = update (S.fprintfx_fun fmt f);;
let fprintfx_var v fmt = update (S.fprintfx_var fmt v);;
